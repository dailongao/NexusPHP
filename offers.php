...
print("<li>".$lang_offers['text_rule_one_one'].get_user_class_name($addoffer_class, false, true, true).$lang_offers['text_rule_one_three'].get_user_class_name($upload_class, false, true, true).$lang_offers['text_rule_one_two']."</li>\n");
...
print("<li>".$lang_offers['text_rule_five_one'].get_user_class_name(UC_UPLOADER, false, true, true).$lang_offers['text_rule_five_two']."</li>");
print("<li>".$lang_offers['text_rule_six']."</li>");
print("<li>".$lang_offers['text_rule_seven']."</li>");
print("</ul></div>");

// Offer tips
print("<p align=\"left\"><b><font size=\"5\">".$lang_offers['text_tips']."</font></b></p>\n");
print("<div align=\"left\"><ul>");
print("<li>".$lang_offers['text_tips_one']."</li>");
print("<li>".$lang_offers['text_tips_two']."</li>");
print("<li>".$lang_offers['text_tips_three']."</li>");
print("</ul></div>");
