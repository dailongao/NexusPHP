...
if (isset($searchstr))
{
	...
	$addparam .= "search=" . urlencode($searchstr) . "&".$notnewword;
}
...
<form method="get" name="searchbox" action="?">
	<table border="1" class="searchbox" cellspacing="0" cellpadding="5" width="100%">
		<tbody>
		<tr>
		<td class="colhead" align="center" colspan="2"><?php echo $lang_torrents['text_search_box'] ?><a href="javascript: klappe_news('searchboxmain')"><img class="minus" src="pic/trans.gif" id="picsearchboxmain" alt="Show/Hide" /></a></td>
		</tr></tbody>
					...
					<tr>
						...
						<td class="embedded">
							<table>
								<tr>
									<td class="embedded">
										<input id="searchinput" name="search" type="text" value="<?php echo  $searchstr_ori ?>" style="width: 200px" ondblclick="suggest(event.keyCode,this.value,'torrents');" onkeyup="suggest(event.keyCode,this.value,'torrents');" onkeypress="return noenter(event.keyCode);"/>
...
if (!$Cache->get_page()){
	...
	{
		$hotsearch .= "<a href=\"".htmlspecialchars("?search=" . urlencode($searchrow["keywords"]) . "&notnewword=1")."\"><u>" . $searchrow["keywords"] . "</u></a>&nbsp;&nbsp;";
