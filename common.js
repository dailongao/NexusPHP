...
noext = noext.replace(/\bH\.264\b/ig,"H_264");
noext = noext.replace(/\bH\.265\b/ig,"H_265");
...
{
if (document.getElementById(blockid).innerHTML==""){
var infoblock=ajax.gets('getdoubanajax.php?douban_url='+url+'&cache='+cache+'&type='+type);
document.getElementById(blockid).innerHTML=infoblock;
}
return true;
}
