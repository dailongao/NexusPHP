...
<tr><td class=colhead align=left><?php echo $lang_messages['col_new_message']; ?></td></tr>
<tr><td class=toolbox align=center><form method="get" action="sendmessage.php"><? echo $lang_messages['col_receiver']; ?>&nbsp;<input type="text" style="width: 100px;" value="" name="name"/>&nbsp;<input type="submit" value="<?=$lang_messages['submit_pm'];?>" class="btn"></form></td></tr>
</table>
<br /><br />
...
<tr>
<td colspan="2" align="left"><div><?php echo $body?></div></td>
</tr>
<tr>
<td align=left><div>
...
?>
</div></td><td align="right" ><font color=white>[ <a href="messages.php?action=deletemessage&id=<?php echo $pm_id?>"><?php echo $lang_messages['text_delete'] ?></a> ]<?php echo $reply?> [ <a
