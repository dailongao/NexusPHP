...
if ($action == "viewposts")
{
	...
	$select_is = "f.id AS f_id, f.name, t.id AS t_id, t.casinomode AS t_mode, t.subject, t.lastpost, r.lastpostread, p.*";
	...
	while ($arr = mysql_fetch_assoc($res))
	{
		...
		$topicmode = $arr["t_mode"];
		if($topicmode == "yes") $topicmode = 1;
		else $topicmode = 0;
