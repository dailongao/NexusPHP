...
(
	...
	'row_enable_douban_system' => "開啟Douban系統",
	'text_douban_system_note' => "預設'是'。全域Douban系統設定。",
	...
	'text_smtp_account_password_note' => "<b>輔助說明：</b>匯入你的密碼",
        'text_smtp_eYou' => "External + eYou（使用外部eYou Web郵件系統）",
        'text_setting_for_eYou_type' => "eYou類型設定",
        'row_eYouAccount' => 'eYou用戶名',
        'row_eYouAccountDomain' => 'eYou賬戶域名',
        'row_eYouAccountPass' => 'eYou賬戶密碼',
        'row_eYouUrl' => 'eYou系統URL',
        'text_eYouAccount_note' => '<b>提示：</b> 郵箱地址@前​​字符',
        'text_eYouAccountDomain_note' => '<b>輔助說明：</b> 郵箱地址@後字符',
        'text_eYouAccountPass_note' => '<b>輔助說明：</b>輸入你的密碼',
        'text_eYouUrl_note' => '<b>輔助說明：</b> 如http://st.zju.edu.cn/',
	...
	'row_casino_enabled' => "開啟賭場系統",
	'text_enable_casino_note' => "默認'否'。是否開啟賭場系統。",
	'row_enter_casino' => "進入賭場",
	'text_enter_casino_note' => "。允許使用者打開賭場頁面",
	'row_casino_min_bonus' => "進入賭場最低魔力值",
	'text_casino_min_bonus_note' => "默認'2000'。魔力值小於這個值將不能進入賭場",
	...
	'head_federation_settings' => "联盟设置",
	'head_save_federation_settings' => "保存联盟设置",
	'submit_federation_settings' => "联盟设置",
	'row_federation_settings' => "联盟设置",
	'text_federation_settings' => "更改跨站点联合访问相关的设置。",
	'row_cc98_client_id' => "CC98 Client Id",
	'text_cc98_client_id' => "CC98 OAuth API Key 的 'client_id' 参数值。",
