...
(
	...
	'select_type_select' => "(請選擇)",
	'row_type' => "類型",
	'row_title' => "標題",
	'row_post_or_photo' => "海報或圖片",
	'text_link_to_picture' => "(圖示的連結。不要加<a href=\"tags.php\" title=\"查看標籤用法\">標籤</a>代碼! 顯示在簡介裡)",
	'row_description' => "簡介",
	'submit_add_offer' => "添加",
	'col_type' => "類型",
	'col_title' => "標題",
	...
	'col_offered_by' => "添加者",
	'submit_show_all' => "顯示全部",
	'std_must_enter_name' => "你必須輸入標題！",
	'std_must_select_category' => "你必須選擇候選的類型！",
	'stdst_enter_description' => "你必須填寫簡介！",
	'std_wrong_image_format' => "圖片必須是jpg, gif 或png格式。",
	'head_success' => "成功！",
	'head_error' => "錯誤！",
	'std_offer_exists' => "候選已經存在！",
	'text_view_all_offers' => "查看所有候選",
	...
	'std_already_voted_note' => "<p>你已經投過票，每個候選只能投一次。</p><p>返回到",
	...
	'std_cannot_delete_others_offer' => "你沒有許可權刪除別人的候選",
	'std_delete_offer' => "刪除候選",
	'std_delete_offer_note' => "你將要刪除該候選。",
	'head_offers' => "候選",
	'text_offers_section' => "候選區",
	'text_add_offer' => "添加候選",
	'text_view_request' => "查看求種",
	'select_show_all' => "(顯示全部)",
	'submit_view_only_selected' => "顯示選擇",
	...
	'text_yep' => "是",
	'text_nah' => "否",
	'title_show_vote_details' => "顯示投票詳情",
	...
	'text_new' => "新",
	'std_cannot_vote_youself' => "你不能給自己提交的候選投票。",
	'text_rules' => "規則：",
	'text_rule_one_one' => "",
	'text_rule_one_two' => "及以上等級的使用者可直接發佈種子，無需經過候選。",
	'text_rule_one_three' => "或以上等級的使用者可以添加候選。",
	'text_rule_two_one' => "當候選的支持票比反對票多",
	'text_rule_two_two' => "票時，候選被通過。",
	'text_rule_three_one' => "如候選在添加",
	'text_rule_three_two' => "小時後未被通過，它將被刪除。",
	'text_rule_four_one' => "如在候選通過後",
	'text_rule_four_two' => "小時內用戶沒有發佈種子，通過的候選將被刪除。",
	'text_rule_five_one' => "學習類和漫畫類資源，除",
	'text_rule_five_two' => "及以上等級或管理組指定的用戶以外，其他用戶必須先添加候選等待管理組通過。",
	'text_rule_six' => "請確保提交候選的資源不與站內已有資源重複（搜索時請包括斷種），且品質不遜於站內已有資源。",
	'text_rule_seven' => "詳情請閱讀<a href='rules.php'><b>規則</b></a>的上傳規則部分或諮詢管理組。如果不符合相關規定，將不經提醒直接刪除。",
	'text_tips' => "Tips：",
	'text_tips_one' => "視頻類資源，不允許 RMVB / RM / 槍版 / TC / DVDSCR / R5 / HalfCD 等品質不滿足要求的視頻。請在發佈時給出<b>視頻資訊</b>。",
	'text_tips_two' => "音訊類資源，只允許無損格式音訊（電影類音軌除外），不允許MP3等有損音訊。",
	'text_tips_three' => "遊戲類資源，只允許鏡像或其他官方發佈形式，不允許硬碟版遊戲。",
);
