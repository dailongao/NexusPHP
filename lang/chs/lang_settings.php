...
(
	...
	'row_enable_douban_system' => "开启Douban系统",
	'text_douban_system_note' => "默认'是'。全局Douban系统设定。",
	...
	'text_smtp_account_password_note' => "<b>提示：</b>输入你的密码",
        'text_smtp_eYou' => "External + eYou（使用外部eYou Web邮件系统）",
        'text_setting_for_eYou_type' => "eYou类型设定",
        'row_eYouAccount' => 'eYou用户名',
        'row_eYouAccountDomain' => 'eYou账户域名',
        'row_eYouAccountPass' => 'eYou账户密码',
        'row_eYouUrl' => 'eYou系统URL',
        'text_eYouAccount_note' => '<b>提示：</b> 邮箱地址@前字符',
        'text_eYouAccountDomain_note' => '<b>提示：</b> 邮箱地址@后字符',
        'text_eYouAccountPass_note' => '<b>提示：</b>输入你的密码',
        'text_eYouUrl_note' => '<b>提示：</b> 如 http://st.zju.edu.cn/',
	...
	'row_casino_enabled' => "开启赌场系统",
	'text_enable_casino_note' => "默认'否'。是否开启赌场系统。",
	'row_enter_casino' => "进入赌场",
