...
(
	...
	'p_need_cookies_enables' => "<b>注意</b>: 你需要启用cookies才能登录或切换语言<br/>如果出现注册失败或帐号被禁用的情况，请发邮件至 <a href=\"mailto:staff@nexushd.org\">staff@nexushd.org</a>。",
	'p_fail_ban' => "次连续登录失败将导致你的IP地址被禁用!",
		//'p_you_have' => "你还有",
		//'p_remaining_tries' => "次尝试机会",
	'p_login_remaing_tries_format' => "你还有 <b>{0}</b> 次尝试机会",
