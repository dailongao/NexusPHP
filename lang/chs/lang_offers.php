...
(
	...
	'text_rule_five_one' => "学习类和漫画类资源，除",
	'text_rule_five_two' => "及以上等级或管理组指定的用户以外，其他用户必须先添加候选等待管理组通过。",
	'text_rule_six' => "请确保提交候选的资源不与站内已有资源重复（搜索时请包括断种），且质量不逊于站内已有资源。",
	'text_rule_seven' => "详情请阅读<a href='rules.php'><b>规则</b></a>的上传规则部分或咨询管理组。如果不符合相关规定，将不经提醒直接删除。",
	'text_tips' => "Tips：",
	'text_tips_one' => "视频类资源，不允许 RMVB / RM / 枪版 / TC / DVDSCR / R5 / HalfCD 等质量不满足要求的视频。请在发布时给出<b>视频信息</b>。",
	'text_tips_two' => "音频类资源，只允许无损格式音频（电影类音轨除外），不允许MP3等有损音频。",
	'text_tips_three' => "游戏类资源，只允许镜像或其他官方发布形式，不允许硬盘版游戏。",
);
