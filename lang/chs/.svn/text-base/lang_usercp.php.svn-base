...
(
	...
	'text_minor_douban_info' => "简单Douban信息 (片名 + 年代 +  Douban评分 + 国家 + 类别 + 导演 + 主演)",
	'text_median_douban_info' => "中型Douban信息 (图片 + 片名 + 年代 +  Douban评分 + 片长 + 国家 + 对白语言 + 导演 + 类别 + 主演 + 中文剧情概要)",
