...
(
	...
	'text_show_douban_info' => "Show Douban Information",
	...
	'text_minor_douban_info' => "Minor Douban Info (Title + Year +  Douban Rating + Country + Genre + Director + Main Cast)",
	'text_median_douban_info' => "Median Douban Info (Picture + Title + Year +  Douban Rating + Runtime + Country + Language + Director + Genre + Main Cast + Summary in Chinese)",
	'text_off' => "Off",
	...
	'row_showonline' => "Show online status",
	'radio_yes' => "yes",
	'radio_no' => "no",
);
