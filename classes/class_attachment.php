...
class ATTACHMENT {
  ...
  function get_count_limit_class($class) {
    global $classone_attachment, $classtwo_attachment, $classthree_attachment, $classfour_attachment,
           $countone_attachment, $counttwo_attachment, $countthree_attachment, $countfour_attachment;
  ...
  function get_count_left() {
    return $this->countlimit - $this->countsofar;
  }

  function get_size_limit_class($class) {
    global $classone_attachment, $classtwo_attachment, $classthree_attachment, $classfour_attachment,
           $sizeone_attachment, $sizetwo_attachment, $sizethree_attachment, $sizefour_attachment;
  ...
  function get_allowed_ext_class($class) {
    global $classone_attachment, $classtwo_attachment, $classthree_attachment, $classfour_attachment,
           $extone_attachment, $exttwo_attachment, $extthree_attachment, $extfour_attachment;
    $allowedext = array();
