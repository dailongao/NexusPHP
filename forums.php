...
loggedinorreturn();
parked();
//check whether internal forum is disabled
    ...
    ?>
      <td align="left" colspan="3">
			<span id="order" onclick="dropmenu(this);"><span
                        style="cursor: pointer;"><b><?= $lang_forums['text_order'] ?></b></span>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="512" class="search_table">
                    ...
                    <tr>
                        <td style="padding-bottom: 3px; border: 0;"
                            valign="top"><?= $lang_forums['text_by_keyword'] ?></td>
                    </tr>
                    <tr>
                        ...
                        <td style="padding-bottom: 3px; border: 0;" valign="top"><input name="image" type="image"
                                                                                        ...
                                                                                        src="<?= get_forum_pic_folder() ?>/search_button.gif"
                                                                                        alt="Search"/></td>
                    </tr>
                    </tbody>
                </table>
