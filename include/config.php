...
$showextinfo['douban'] = $MAIN['showdoubaninfo'];
...
$eYouAccount = $SMTP['eYouAccount'];
$eYouAccountDomain = $SMTP['eYouAccountDomain'];
$eYouAccountPass = $SMTP['eYouAccountPass'];
$eYouUrl = $SMTP['eYouUrl'];
