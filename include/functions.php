...
<link rel="stylesheet" href="styles/jquery.custom.css<?php echo $cssupdatedate?>" type="text/css" />
<?php
if ($CURUSER){
	$caticonrow = get_category_icon_row($CURUSER['caticon']);
...
<script type="text/javascript" src="jquery.min.js<?php echo $cssupdatedate?>"></script>
<script type="text/javascript" src="jquery.ui.min.js<?php echo $cssupdatedate?>"></script>
<script type="text/javascript" src="jquery.boxy.js<?php echo $cssupdatedate?>"></script>
...
<table id="info_block" cellpadding="4" cellspacing="0" border="0" width="100%"><tr>
	<td><table width="100%" cellspacing="0" cellpadding="0" border="0"><tr>
		<td class="bottom" align="left"><span class="medium"><?php echo $lang_functions['text_welcome_back'] ?>, <?php echo get_username($CURUSER['id'])?>  [<a href="logout.php"><?php echo $lang_functions['text_logout'] ?></a>]<?php if (get_user_class() >= UC_MODERATOR) { ?> [<a href="staffpanel.php"><?php echo $lang_functions['text_staff_panel'] ?></a>] <?php }?> <?php if (get_user_class() >= UC_SYSOP) { ?> [<a href="settings.php"><?php echo $lang_functions['text_site_settings'] ?></a>]<?php } ?> [<a href="torrents.php?inclbookmarked=1&amp;allsec=1"><?php echo $lang_functions['text_bookmarks'] ?></a>] [<a href="bitbucket-list.php?mode=1"><?php echo $lang_functions['text_attachments'] ?></a>] <font class = 'color_bonus'><?php echo $lang_functions['text_bonus'] ?></font><?php if ( $casino_tweak == "yes" && get_user_class() >= $casino_class ) { ?> [<a href="casino.php#tabs-2"><?php echo $lang_functions['text_casino'] ?></a>]<?php }?>[<a href="mybonus.php"><?php echo $lang_functions['text_use'] ?></a>]: <?php echo number_format($CURUSER['seedbonus'], 1)?> <font class = 'color_invite'><?php echo $lang_functions['text_invite'] ?></font>[<a href="invite.php?id=<?php echo $CURUSER['id']?>"><?php echo $lang_functions['text_send'] ?></a>]: <?php echo $CURUSER['invites']?><br />
