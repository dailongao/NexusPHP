...
function begin_compose($title = "", $type = "new", $body = "", $hassubject = true, $subject = "", $maxsubjectlength = 100, $hasmodechoose = false)
{
	global $lang_functions;
	if ($title)
	...
	if ($hassubject) {
		...
		if ($hasmodechoose) {
			print("&nbsp;&nbsp;<input type=\"checkbox\" name=\"casinomode\">" . $lang_functions['row_casinoenable'] . "</input>");
		}
		print("</td></tr>\n");
	}
