		...
		<tr>
			<td align="left" colspan="2">
				<table cellspacing="1" cellpadding="2" border="0">
					<tr>
						<td class="embedded">
							<input style="font-weight: bold; font-size: 11px; margin-right: 3px" type="button" name="b" value="B" onclick="javascript: simpletag('b')" />
						</td>
						<td class="embedded">
							<input class="codebuttons" style="font-style: italic; font-size: 11px; margin-right: 3px" type="button" name="i" value="I" onclick="javascript: simpletag('i')" />
						</td>
						<td class="embedded">
							<input class="codebuttons" style="text-decoration: underline; font-size: 11px; margin-right: 3px" type="button" name="u" value="U" onclick="javascript: simpletag('u')" />
						</td>
						<?php
						...
						?>
						<td class="embedded">
							<input class="codebuttons" style="font-size: 11px; margin-right: 3px" type="button" name="quote" value="QUOTE" onclick="javascript: simpletag('quote')" />
						</td>
						<td class="embedded">
							<input style="font-size: 11px; margin-right: 3px" type="button" onclick='javascript:closeall();' name='tagcount' value="Close all tags" />
						</td>
						<td class="embedded">
							<select class="med codebuttons" style="margin-right: 3px" name='color' onchange="alterfont(this.options[this.selectedIndex].value, 'color')">
		...
		?>
			<tr>
				<td colspan="2" valign="middle">
					<iframe src="<?= get_protocol_prefix() . $BASEURL ?>/attachment.php" width="100%" height="24" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
				</td>
			</tr>
		<?php
		}
...
function get_external_tr($url = "", $ext = "imdb")
{
	...
	} else if ($showextinfo['douban'] == 'yes' && $ext == "douban") {
...
function parse_douban_type($url)
{
	if (strpos($url, 'movie.douban.com') != FALSE) {
		return "movie";
	} else if (strpos($url, 'music.douban.com') != FALSE) {
		return "music";
	} else {
		return "movie";
	}
...
?>
	...
	<head>
		...
		?>
				<link rel="stylesheet" href="<?= htmlspecialchars($caticonrow['cssfile']) . $cssupdatedate ?>" type="text/css" />
		<?php
			}
		}
		?>
		...
		<table class="head" cellspacing="0" cellpadding="0" align="center">
			<tr>
				<td class="clear">
					...
					?>
						<div class="logo_img">
							<img src="<?= $logo_main ?>" alt="<?= htmlspecialchars($SITENAME) ?>" title="<?= htmlspecialchars($SITENAME) ?> - <?= htmlspecialchars($SLOGAN) ?>" />
						</div>
					<?php
					}
					?>
										...
										<tr>
											<td class="bottom" align="left"><span class="medium"><?= $lang_functions['text_welcome_back'] ?>, <?= get_username($CURUSER['id']) ?>
													[<a href="logout.php"><?= $lang_functions['text_logout'] ?></a>]<?php if (get_user_class() >= UC_MODERATOR) { ?> [<a href="staffpanel.php"><?= $lang_functions['text_staff_panel'] ?></a>] <?php } ?> <?php if (get_user_class() >= UC_SYSOP) { ?> [<a href="settings.php"><?= $lang_functions['text_site_settings'] ?></a>]<?php } ?> [<a href="torrents.php?inclbookmarked=1&amp;allsec=1"><?= $lang_functions['text_bookmarks'] ?></a>] [<a href="bitbucket-list.php?mode=1"><?= $lang_functions['text_attachments'] ?></a>] <font class='color_bonus'><?= $lang_functions['text_bonus'] ?></font><?php if ($casino_tweak == "yes" && get_user_class() >= $casino_class) { ?> [<a href="casino.php#tabs-2"><?= $lang_functions['text_casino'] ?></a>]<?php } ?>[<a href="mybonus.php"><?= $lang_functions['text_use'] ?></a>]: <?= number_format($CURUSER['seedbonus'], 1) ?> <font class='color_invite'><?= $lang_functions['text_invite'] ?></font>[<a href="invite.php?id=<?= $CURUSER['id'] ?>"><?= $lang_functions['text_send'] ?></a>]: <?= $CURUSER['invites'] ?><br />
														...
														<img class="arrowdown" alt="Torrents leeching" title="<?= $lang_functions['title_torrents_leeching'] ?>" src="pic/trans.gif" /><?= $activeleech ?>&nbsp;&nbsp;<font class='color_connectable'><?= $lang_functions['text_connectable'] ?></font><?= $connectable ?> <?= maxslots(); ?>
												</span></td>

											<td class="bottom" align="right"><span class="medium">
													<?
													if ($enabledonation) {
													?> [<a href="donate.php" class="altlink_green"><?= $lang_functions['text_donate'] ?></a>] <?
																																																									}
			...
			<tr>
				...
				<table class="torrents" cellspacing="0" cellpadding="5" width="100%">
					<tr>
						...
						<td class="colhead"><a href="?<?= $oldlink ?>sort=1&amp;type=<?= $link[1] ?>"><?= $lang_functions['col_name'] ?></a></td>
						<?php
						...
						if ($CURUSER['showcomnum'] != 'no') { ?>
							<td class="colhead"><a href="?<?= $oldlink ?>sort=3&amp;type=<?= $link[3] ?>">
									<img class="comments" src="pic/trans.gif" alt="comments" title="<?= $lang_functions['title_number_of_comments'] ?>" /></a></td>
						<?php } ?>

						<td class="colhead"><a href="?<?= $oldlink ?>sort=4&amp;type=<?= $link[4] ?>">
								<img class="time" src="pic/trans.gif" alt="time" title="<?= ($CURUSER['timetype'] != 'timealive' ? $lang_functions['title_time_added'] : $lang_functions['title_time_alive']) ?>" /></a></td>
						<td class="colhead"><a href="?<?= $oldlink ?>sort=5&amp;type=<?= $link[5] ?>">
								<img class="size" src="pic/trans.gif" alt="size" title="<?= $lang_functions['title_size'] ?>" /></a></td>
						<td class="colhead"><a href="?<?= $oldlink ?>sort=7&amp;type=<?= $link[7] ?>">
								<img class="seeders" src="pic/trans.gif" alt="seeders" title="<?= $lang_functions['title_number_of_seeders'] ?>" /></a></td>
						<td class="colhead"><a href="?<?= $oldlink ?>sort=8&amp;type=<?= $link[8] ?>">
								<img class="leechers" src="pic/trans.gif" alt="leechers" title="<?= $lang_functions['title_number_of_leechers'] ?>" /></a></td>
						<td class="colhead"><a href="?<?= $oldlink ?>sort=6&amp;type=<?= $link[6] ?>">
								<img class="snatched" src="pic/trans.gif" alt="snatched" title="<?= $lang_functions['title_number_of_snatched'] ?>" /></a></td>
						<td class="colhead"><a href="?<?= $oldlink ?>sort=9&amp;type=<?= $link[9] ?>"><?= $lang_functions['col_uploader'] ?></a></td>
						<?php
				...
				<?php
					...
					while ($row = mysql_fetch_assoc($res)) {
						...
						if (!$has_tooltip)
							...
							else if ($tooltiptype == 'minordouban' || $tooltiptype == 'mediandouban')
...
" . ($plots ? "<tr><td class=\"clear\" colspan=\"2\">" . $plots . "</td></tr>" : "") . "
				...
				function get_torrent_promotion_append($promotion = 1, $forcemode = "", $showtimeleft = false, $added = "", $promotionTimeType = 0, $promotionUntil = '')
				{
					...
					$timeout = gettime(date("Y-m-d H:i:s", $futuretime), false, false, true, false, true);
					if ($promotion != 1 && $promotionTimeType != 0) $sp_torrent .= "&nbsp;[" . $lang_functions['text_will_end_in'] . "<b>" . $timeout . "</b>]";
					return $sp_torrent;
				}
